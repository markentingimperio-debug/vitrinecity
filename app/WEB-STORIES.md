...
`node --test scripts/test-web-stories.mjs` cobre autenticação/CSRF, privacidade do rascunho/prévia, revisão obrigatória, snapshots, fonte alterada/retirada, XSS/URLs, conteúdo mínimo, concorrência, sitemaps e dimensões reais de arquivos locais.
