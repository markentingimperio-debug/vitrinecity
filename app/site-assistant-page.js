...
export function injectSiteAssistant(html, { path = '', amp = false } = {}) {
  ...
  const css = /\bhref\s*=\s*["']\/site-assistant\.css(?:[?"'])/i.test(html) ? '' : '<link rel="stylesheet" href="/site-assistant.css?v=20260911-course-help">';
  const loader = '<script type="module" src="/site-assistant.js?v=20260911-course-help" data-vc-site-assistant="enabled"></script>';
