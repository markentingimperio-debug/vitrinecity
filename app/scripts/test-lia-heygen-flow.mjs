...
function spec({count=1,duration=5,speaker=true}={}){return {projectRevisionId:'reviewed-1',durationSeconds:count*duration,aspectRatio:'9:16',language:'pt-BR',audioMode:speaker?'character_speech':'narration',voiceProfileId:'approved-voice',captions:'none',scenes:Array.from({length:count},(_,i)=>({id:'scene_'+(i+1),durationMs:duration*1000,speech:'Olá!',speakerVisible:speaker,source:'generated_scene'}))};}
