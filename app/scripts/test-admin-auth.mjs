...
try{
  ...
  db.prepare("INSERT INTO social_posts(id,user_id,video_uid,caption,category,city,status) VALUES ('intelligence-post',?,'video-intelligence','Conteúdo teste','negocios','Anápolis','ready')").run(userId);
