...
assert.deepEqual(SPATIAL_CITY_IDENTITY_IDS,['vitrine-city','silvania','anapolis','goiania']);
...
console.log(JSON.stringify({ok:true,cities:SPATIAL_CITY_IDENTITY_IDS.length,theme:fetched.themeId}));
