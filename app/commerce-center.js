...
export function createCommerceCenter({ db, now = Date.now }) {
  ...
  function overview(sheetsStatus = {}, shopeeStatus = {}) {
    ...
    const connections = [
      ...
      { id: 'kwai', name: 'Kwai Shop Brasil', status: 'needs_approval', detail: 'É necessário confirmar o acesso de parceiro à API brasileira. A conexão de vídeos do Kwai não dá acesso à loja, pedidos ou anúncios.', actionUrl: 'https://shop.kwai.com/pages/goods-manage/list', sourceMode: 'approval_required', lastSyncAt: null },
