...
export const CITY_GUIDE_ITEMS = Object.freeze([
  ...
  { id: 'social', title: 'Vitrine Social', description: 'Descubra publicações e acompanhe pessoas e negócios.', group: 'diversao', keywords: ['rede social', 'feed', 'comunidade', 'perfil', 'publicações', 'amigos'], href: '/social', landmark: 'Praça de convivência', place: 'social' },
  ...
  { id: 'mensagens', title: 'Minhas mensagens', description: 'Acesse suas conversas na Vitrine Social.', group: 'diversao', keywords: ['chat', 'mensagem', 'conversa', 'social'], href: '/chat-social.html', landmark: 'Praça de convivência', place: 'social' },
