(() => {
  ...
  async function seedPilot() {
    ...
    await request('/episodes','POST',{seriesId:s.id,number:1,title:'A traição era só o começo',summary:'Um jantar, uma fotografia e uma pergunta que ninguém esperava.',targetSeconds:80,budgetBrl:0,script:'00–07 | Detalhe da mesa posta. Narrador: “Ana preparou um jantar. Mas não estava comemorando o casamento.”\n07–18 | Marcos se senta. Marcos: “Você disse que era uma surpresa.” Ana: “É. E eu queria que a Bia estivesse aqui.”\n18–30 | Bia entra; vê Marcos e hesita. Bia: “Aconteceu alguma coisa?” Ana coloca uma fotografia na mesa.\n30–42 | Ana: “Eu sei sobre vocês dois.” Marcos: “Você está entendendo tudo errado.”\n42–55 | Reação silenciosa de Bia. Ana: “A traição eu já sabia.” Trilha diminui; som do relógio.\n55–68 | Ana apresenta um anúncio impresso. Ana: “Quero saber por que colocaram a minha casa à venda.”\n68–80 | Bia: “Marcos, você disse que ela tinha assinado.” Ana: “Assinado o quê?” Corte antes da resposta.',scenes:[
      {number:1,seconds:10,description:'Plano detalhe da mesa de jantar preparada. Ana organiza os talheres; câmera lenta aproxima do rosto dela. Manter Ana pelo Element permanente, blusa preta e expressão controlada.',dialogue:'Narrador: Ana preparou um jantar. Mas não estava comemorando o casamento.'},
      {number:2,seconds:10,description:'Marcos chega e senta à mesa. Plano médio alternando Ana e Marcos. Marcos mantém camisa azul-marinho e identidade permanente.',dialogue:'Marcos: Você disse que era uma surpresa. Ana: É. E eu queria que a Bia estivesse aqui.'},
      {number:3,seconds:10,description:'Bia entra pela porta, vê Marcos e hesita por um instante. Ana observa em silêncio. Preservar Bia conforme Element aprovado e roupa vinho durante toda a sequência.',dialogue:'Bia: Aconteceu alguma coisa?'},
      {number:4,seconds:10,description:'Ana coloca uma fotografia sobre a mesa. Close na fotografia sem mostrar pessoas reconhecíveis e corte para reação de Marcos e Bia.',dialogue:'Ana: Eu sei sobre vocês dois. Marcos: Você está entendendo tudo errado.'},
      {number:5,seconds:10,description:'Close de Bia em silêncio; depois Ana, firme. Música reduz e entra som discreto de relógio.',dialogue:'Ana: A traição eu já sabia.'},
      {number:6,seconds:10,description:'Ana desliza um anúncio de imóvel sobre a mesa. Marcos perde a segurança. Câmera sobre o ombro de Ana.',dialogue:'Ana: Quero saber por que colocaram a minha casa à venda.'},
      {number:7,seconds:10,description:'Bia encara Marcos, surpresa e tensa. Alternância de close entre os dois, preservando figurino e iluminação.',dialogue:'Bia: Marcos, você disse que ela tinha assinado.'},
      {number:8,seconds:10,description:'Close final em Ana. Silêncio curto antes da pergunta. Terminar no olhar de Marcos sem revelar a resposta, criando cliffhanger.',dialogue:'Ana: Assinado o quê?'}
    ]});
