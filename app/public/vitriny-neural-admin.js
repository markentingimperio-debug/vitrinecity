(()=>{
  ...
  let snapshot=null,skillsSnapshot=null,qualifications=[],benchmarkTimer=null,runningTest=false,researchSnapshot=null,researchCandidates=[],researchRunning=false;
