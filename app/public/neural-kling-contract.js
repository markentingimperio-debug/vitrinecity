...
export const KLING_READINESS_VERSION = 1;
...
export function assertKlingReadiness(value) {
  ...
  if (value.version !== 1 || value.provider !== 'kling_api' || !Object.hasOwn(KLING_READINESS_STATES,value.stage) || typeof value.configured !== 'boolean') invalid();
  ...
  if (value.stage === 'access_verified' ? value.packageCount === null : value.packageCount !== null) invalid();
  return value;
}
